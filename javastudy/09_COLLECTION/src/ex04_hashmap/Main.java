...
public class Main {
	...
	public static void m1() {
		...
		System.out.println(dictionary.get("peach")); // 복숭아는 없기 때문에 null값이 나온다
	...
	public static void m4() {
		...
		// Array에 저장된 Map 3개를 for문으로 순회하시오
