...
/*
 	...
 	2.contextDestroyed():웹 애플리케이션 종료할 때 동작
    ...
    public void contextInitialized(ServletContextEvent arg0)  { 
    	 ...
    	 * Cron Expression(크론식)- www.cronMaker.com 참고해 볼 것
    	  ...
    	  2. 상세
    	  	...
    	  	3) 시: 0~23
    	  	4) 일: 1~31
    	  	5) 월: 0~11 또는 JAN FEB MAR APR MAY JUN AUS SEP OCT NOV DEC
    	  	6) 요일: 1(MON)~ 7(SUN) 또는 MOT,TUE WED THR FRI SAT SUN
