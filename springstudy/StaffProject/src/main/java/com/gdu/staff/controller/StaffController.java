...
public class StaffController {
	...
	@PostMapping(value="/add", produces="text/plain; charset=UTF-8")
	 public ResponseEntity<String> add(HttpServletRequest request) { //ajax 전용 객체
	...
	/*
	 ...
	 public ResponseEntity<String> add(@RequestParam(value="son")String son
	  									,@RequestParam(value="name", required=false) String name
	  									,@ RequestParam(value="dept",String dept) { 
	  	String staff=new StaffDTO(sno,name,dept,0);
		 return staffService.addStaff(staff);							
	...
	public StaffDTO select(HttpServletRequest request) {
		 String sno=request.getParameter("sno");
		 return staffService.getSelectStaff(sno);
